  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-10">
      <header className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-text">My Events</h1>
      ...
      <div className="grid gap-4 md:grid-cols-3 mb-8">
        <div className="rounded-2xl border border-border bg-surface p-6">
          <p className="text-xs text-muted uppercase tracking-wider mb-1">Total Events</p>
          <p className="text-3xl font-bold text-text">{events.length}</p>
        </div>
        <div className="rounded-2xl border border-border bg-surface p-6">
          <p className="text-xs text-muted uppercase tracking-wider mb-1">Total Registrations</p>
      ...
      <div className="rounded-2xl border border-border overflow-hidden">
        <div className="border-b border-border bg-surface px-6 py-4">
          <h2 className="text-sm font-semibold text-muted uppercase tracking-wider">Events</h2>
        </div>
        {events.length === 0 ? (
            ...
            <table className="w-full text-sm">
              <thead className="border-b border-border bg-surface-raised">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-muted font-medium">Start Date</th>
                  <th className="px-4 py-3 text-left text-muted font-medium">Location ID</th>
